...
public record Observation(
    ...
    public static Observation missingInputs(String runId, String taskNodeId, String capabilityName,
                                            List<String> missingInputs) {
        return new Observation(null, runId, taskNodeId, capabilityName, "waiting_for_user",
                "Need more information before this capability can run.", Map.of(), Map.of(), 0.2,
                missingInputs, "low", false, null, "MISSING_INPUTS", false, List.of(), List.of(), Map.of());
    }

    public static Observation failed(String runId, String taskNodeId, String capabilityName, String summary,
                                     String errorType, boolean retryable) {
        return new Observation(null, runId, taskNodeId, capabilityName, "failed", summary, Map.of(), Map.of(),
