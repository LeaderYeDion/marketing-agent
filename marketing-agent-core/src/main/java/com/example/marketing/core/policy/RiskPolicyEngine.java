...
public class RiskPolicyEngine {
    public RiskAssessment assess(CapabilityDescriptor capability, TaskNode taskNode, Map<String, Object> inputs) {
        ...
        boolean requiresApproval = (capability.requiresHumanApproval() || highRisk) && !approvedByPendingAction;
        ...
        String reason = requiresApproval
                ...
                : "Capability is read-only or execution was authorized by a pending action state-machine transition.";
